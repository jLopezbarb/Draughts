...
public class CoordinateTest {
    ...
    @Test
    public void testGivenTwoCoordinatesWhenAreInDiagonalThenCheckDistance(){
        assertEquals(3,new Coordinate(3, 4).diagonalDistance(new Coordinate(0, 7)));
    }

    @Test
    public void testGivenACoordinatesThenIsCorrect(){
        assertTrue(new Coordinate(0,0).isValid());
    }
